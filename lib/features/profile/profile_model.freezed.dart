...
mixin _$ProfileModel {
  ...
  List<SmallWare> get smallWares => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      appliances: null == appliances
          ...
          : appliances // ignore: cast_nullable_to_non_nullable
              as List<Appliance>,
      smallWares: null == smallWares
          ? _value.smallWares
          : smallWares // ignore: cast_nullable_to_non_nullable
              as List<SmallWare>,
      diets: null == diets
          ? _value.diets
...
class _$_ProfileModel implements _ProfileModel {
  ...
  final List<SmallWare> _smallWares;
  @override
  @JsonKey(name: 'small_wares')
  List<SmallWare> get smallWares {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_smallWares);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._smallWares, _smallWares) &&
...
abstract class _ProfileModel implements ProfileModel {
  const factory _ProfileModel(
      ...
      final List<Diet> diets}) = _$_ProfileModel;
